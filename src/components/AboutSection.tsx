      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Main Narrative Card */}
            <div className="p-6 sm:p-8 rounded-2xl bg-[#0b0f19] border border-slate-700/80 hover:border-cyan-500/40 shadow-sm transition-all space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-800">
                ...
                <div className="p-4 rounded-xl bg-[#060810] border border-slate-800">
                  ...
                  <div className="font-bold text-cyan-400 text-base mt-1 flex items-center gap-2">
                    <span>CGPA {profile.cgpa} / 4.0</span>
                    <span className="text-[11px] px-2 py-0.5 rounded bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 font-mono font-bold">
                      Dean&apos;s Honor List
                    </span>
                  </div>
                  <div className="text-xs text-slate-300 mt-0.5 font-mono">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-[#0b0f19] border border-slate-700/80 hover:border-cyan-500/40 shadow-sm transition-all space-y-3">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 sm:p-8 rounded-2xl bg-[#0b0f19] border border-slate-700/80 hover:border-cyan-500/40 shadow-sm transition-all space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-slate-800">
                <h3 className="font-bold text-lg text-white flex items-center gap-2">
                  <Briefcase className="w-5 h-5 text-cyan-400" />
                  <span>Journey &amp; Education</span>
                </h3>
                <span className="text-xs font-mono text-cyan-300 bg-cyan-500/15 border border-cyan-500/30 px-2.5 py-1 rounded font-semibold">
                  5th Semester
                </span>
              </div>

              {/* Interactive Vertical Timeline */}
              <div className="relative pl-6 space-y-8 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-gradient-to-b before:from-cyan-500 before:via-cyan-600/40 before:to-white/10">
                
                {/* 1. BS Software Engineering */}
                <div className="relative group">
                  <div className="absolute -left-[27px] top-1 w-3.5 h-3.5 rounded-full bg-cyan-400 ring-4 ring-[#04060a]" />
                  <span className="text-xs font-mono text-cyan-400 font-bold">2022 — 2026 (Expected)</span>
                ...
                <div className="relative group">
                  <div className="absolute -left-[27px] top-1 w-3.5 h-3.5 rounded-full bg-cyan-400 ring-4 ring-[#04060a]" />
                  <span className="text-xs font-mono text-cyan-400 font-bold">2023 — Present</span>
                  <h4 className="font-bold text-white text-base mt-0.5">
                ...
                <div className="relative group">
                  <div className="absolute -left-[27px] top-1 w-3.5 h-3.5 rounded-full bg-cyan-400 ring-4 ring-[#04060a]" />
                  <span className="text-xs font-mono text-cyan-400 font-bold">2024 — Present</span>
                  <h4 className="font-bold text-white text-base mt-0.5">

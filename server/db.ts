...
export const getInitialData = (): DatabaseSchema => {
  ...
  const defaultPasswordHash = bcrypt.hashSync('admin12345', salt);

  return {
    admin: {
      id: 'admin-1',
      username: 'sajjadsahar',
    ...
    profile: {
      ...
      resumeUrl: "https://drive.google.com/file/d/sajjad-sahar-cv/view",
      ...
      socialLinks: {
        ...
        facebook: "https://facebook.com/sajjadsahar",
        email: "65441@students.riphah.edu.pk",
    ...
    certificates: [
      {
        ...
        certificateId: 'META-FS-984210',
        fileUrl: 'https://images.unsplash.com/photo-1589330694653-dad6bc01cf0f?auto=format&fit=crop&w=1200&q=80',
        fileType: 'image',
        skillsCovered: ['React.js', 'Node.js', 'REST APIs', 'Version Control', 'Databases', 'UI/UX Principles'],
        description: 'Rigorous 9-course curriculum covering modern full-stack development, asynchronous JavaScript, React hooks, database modeling, and automated testing.',
        verificationUrl: 'https://www.coursera.org/verify/professional-cert/META-FS-984210',
      ...
      },
      {
        ...
        certificateId: 'DLAI-NN-554129',
        fileUrl: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80',
        fileType: 'image',
        skillsCovered: ['Neural Networks', 'Backpropagation', 'TensorFlow', 'Python', 'Hyperparameter Tuning'],
        description: 'Comprehensive study of multi-layer perceptrons, convolutional neural architectures, optimization algorithms like Adam, and vectorization techniques.',
        verificationUrl: 'https://www.coursera.org/verify/specialization/DLAI-NN-554129',
        category: 'AI/ML',
        featured: true,
        views: 280
      },
      {
        ...
        issuingOrganization: 'Oracle Certified Associate',
        issueDate: '2024-05-18',
        certificateId: 'ORA-J11-77821',
        fileUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=1200&q=80',
        fileType: 'image',
        skillsCovered: ['Java OOP', 'Collections Framework', 'Generics', 'Exception Handling', 'Streams & Lambdas'],
        description: 'Demonstrated mastery in Java syntax, functional interfaces, thread synchronization, and object-oriented architecture patterns.',
        verificationUrl: 'https://catalog-education.oracle.com/pls/certview/sharebadge?id=ORA-J11-77821',
      ...
      },
      {
        ...
        certificateId: 'MDB-DEV-33019',
        fileUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=1200&q=80',
        fileType: 'image',
        skillsCovered: ['MongoDB', 'Aggregation Pipeline', 'Data Modeling', 'Indexing', 'Mongoose ODM'],
        description: 'Validated expertise in schema design for NoSQL document stores, aggregation operators, replication sets, and query optimization.',
        verificationUrl: 'https://university.mongodb.com/verify/MDB-DEV-33019',
        category: 'Database',
        featured: true,
        views: 215
      },
      {
        ...
        issuingOrganization: 'Stanford Online / edX',
        issueDate: '2024-03-30',
        certificateId: 'STF-DSA-10492',
        fileUrl: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=1200&q=80',
        fileType: 'image',
        skillsCovered: ['Linked Lists', 'Binary Trees', 'Graphs', 'Dynamic Programming', 'Complexity Analysis'],
        description: 'Advanced mastery in asymptotic notation, heap structures, balanced trees, Dijkstra algorithm, and graph search.',
        verificationUrl: 'https://credentials.edx.org/verify/STF-DSA-10492',
        category: 'Programming',
        featured: false,
        views: 195
      }

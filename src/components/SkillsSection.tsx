  ...
  return (
    <section id="skills" className="py-24 relative bg-black/25 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/10 text-cyan-400 text-xs font-mono uppercase tracking-[0.2em] shadow-sm">
        ...
        <motion.div 
          ...
          className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8 p-2 rounded-2xl bg-[#0b0f19] border border-slate-700/80 backdrop-blur-md shadow-sm"
        >
          <div className="flex items-center gap-1.5 p-1 bg-[#060810] rounded-xl border border-slate-800 w-full sm:w-auto">
            <button
          ...
          {/* Quick Stats Pill */}
          <div className="flex items-center gap-4 text-xs font-mono text-slate-300 px-3">
            <span className="flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
              <strong className="text-white font-bold">{skills.length}</strong> Technologies
            </span>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                      ...
                      <motion.button
                        ...
                        className={`flex items-center gap-1.5 px-3.5 py-2 text-xs font-mono uppercase tracking-wider rounded-lg whitespace-nowrap transition-all ${
                          isSelected
                            ...
                            : 'bg-[#0b0f19] text-slate-300 hover:text-white border border-slate-700 hover:border-cyan-400'
                        }`}
                      >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                ...
                <div className="flex items-center gap-1 bg-[#060810] p-1 rounded-lg border border-slate-800 w-full sm:w-auto">
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-xs rounded-lg bg-[#060810] border border-slate-700 text-white placeholder:text-slate-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/30 transition-all"
                  />
                </div>
              </div>
                ...
                {filteredSkills.map((skill) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="relative p-4 rounded-xl bg-[#0b0f19] border border-slate-700/80 hover:border-cyan-500/50 transition-all group flex flex-col justify-between cursor-pointer shadow-sm"
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            <h4 className="font-bold text-white text-base group-hover:text-cyan-300 transition-colors flex items-center gap-1.5">
                          ...
                          {skill.yearsOfExperience && (
                            <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#060810] border border-slate-700 text-slate-300 flex-shrink-0 font-medium">
                              {skill.yearsOfExperience}
                            </span>
                          )}
                        </div>
                        ...
                        <p className="mt-2 text-xs text-slate-300 line-clamp-2 leading-relaxed font-normal">
